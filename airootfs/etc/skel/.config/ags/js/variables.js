...
export const cpu = Variable(0, {
    poll: [intval, '/home/lamb/.config/hypr/scripts/cpu', n => {
        return String(n);
    }],
});
...
export const moon = Variable(0, {
    poll: [250000, '/home/lamb/.config/hypr/scripts/moon', n => {
        return String(n);
    }],
});

export const download = Variable(0, {
    poll: [intval, '/home/lamb/.config/hypr/scripts/rx', n => {
        return String(n);
    }],
});

export const upload = Variable(0, {
    poll: [intval, '/home/lamb/.config/hypr/scripts/tx', n => {
        return String(n);
    }],
});
